...
| Compilers | Inform 6: `inform6` → WebAssembly (Emscripten, single-threaded). ZIL: **ZILF + ZAPF** (C#/.NET 10) → .NET WebAssembly in a Web Worker (main-thread fallback), pre-warmed on `/zil/` |
